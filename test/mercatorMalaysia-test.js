...
tape("geoMercatorMalaysia(point) returns the expected result", function(test) {
  ...
  var proj = d3.geoMercatorMalaysia();
  var locations = [{name:'Kuala Lumpur', coords:[101.696673, 3.113452]},
...
tape("geoMercatorMalaysia.getCompositionBorders() returns the expected result", function(test) {
