...
const projections = [{'name': 'albersUsa', 'topojson': './data/us.json', 'field': 'states'},
{'name': 'albersUsaTerritories', 'topojson': './data/us_territories.json', 'field': 'us'},
{'name': 'conicConformalSpain', 'topojson': './data/provincias.json', 'field': 'provincias'},
{'name': 'conicConformalPortugal', 'topojson': './data/world-50m.json', 'field': 'countries'},
{'name': 'mercatorEcuador', 'topojson': './data/world-50m.json', 'field': 'countries'},
{'name': 'transverseMercatorChile', 'topojson': './data/chile.json', 'field': 'chile'},
{'name': 'conicEquidistantJapan', 'topojson': './data/japan.json', 'field': 'japan'},
{'name': 'conicConformalFrance', 'topojson': './data/france.json', 'field': 'regions'},
{'name': 'conicConformalEurope', 'topojson': './data/nuts0.json', 'field': 'nuts0'},
