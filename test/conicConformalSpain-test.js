...
tape(
  "geoConicConformalSpain(point) returns the expected result",
  function (test) {
    var proj = geoConicConformalSpain();
...
tape(
  "geoConicConformalSpain.getCompositionBorders() returns the expected result",
  function (test) {
    var borders = geoConicConformalSpain().getCompositionBorders();
    test.equal(
